...
while tnow<t_max*60 && to_continue
    frames = [tnow*framerate:(tnow+0.1)*framerate-1];
    ...
    disp('Press SPACE to continue, ESC to quit...');
    ...
    while true
        ...
        switch key
            ...
            case 'escape'
                disp('ESC pressed. Exiting.');
                close all;
                return   % or break / error / exit depending on context
        end
    end
