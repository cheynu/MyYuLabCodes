...
Extrct           =       "ExportVideoFiles(b, FrameInfo, 'Event', 'Press', 'TimeRange', [2000 3000], 'X_Max', 1280, 'Y_Max', 1200, 'SessionName',strrep(fileinfo.MED(1:10), '-', ''), 'RatName', MEDfile(27:strfind(MEDfile, '.')-1), 'Remake', 0)";
...
mask = ExtractMask(VidFiles{2}, [4*60*50 4*60*50+1*10]);
