function tframes_in_b = MapVidFrameTime2Bpod(tLEDon,  tbeh_trigger,  tsROI);
...
for i=1:length(tLEDon)
    ...
    frames_sofar_remap = tsROI(frames_sofar) - tLEDon(i) + tbeh_trigger(i);  % convert the frame time to time in the behavior domain
