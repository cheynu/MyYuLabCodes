GetSeqFrameInfo([0 100]+(10*60+1)*100);
load('FrameInfo.mat')
% FrameInfo = 
%   struct with fields:
...
MEDFile='2021-06-20_14h31m_Subject Pineapple.txt';
BpodFile = 'Pineapple_MedOptoRecMix_20210620_143415.mat';
PosData = 'PosData_pineapple_position2021-06-20T14_35_30.mat';
VidFile = 'pineapple2021-06-20T14_35_30.avi';
...
Extrct           =       "ExportSeqVideoFilesMixedMode(bu, FrameInfo, sout, 'Event', 'Approach', 'TimeRange', [1000 2500], 'SessionName',strrep(FrameInfo.MEDfile(1:10), '-', ''), 'RatName', FrameInfo.MEDfile(27:strfind(FrameInfo.MEDfile, '.')-1), 'Remake', 0, 'ExportRatio', 4);";
