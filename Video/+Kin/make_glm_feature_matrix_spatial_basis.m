function feature_mat = make_glm_feature_matrix_spatial_basis(T, pos_specs, vel_vars, speed_vars, trial_var, basis, varargin)
%MAKE_GLM_FEATURE_MATRIX_SPATIAL_BASIS
