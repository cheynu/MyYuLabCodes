GetSeqFrameInfo([0 500]+(10.5*60+1)*100);
load('FrameInfo.mat')
% FrameInfo = 
%   struct with fields:
...
MEDFile             =       '2021-06-22_16h38m_Subject Pineapple.txt';
BpodFile            =       'Pineapple_MedOptoRecMix_20210622_164135.mat';
PosData             =       'PosData_pineapple_position2021-06-22T16_42_47.mat';
VidFile                =       'pineapple2021-06-22T16_42_47.avi';

bu = GetOptoBehMixDLC(MEDFile, BpodFile, PosData,  VidFile);

bfile = dir('B_*.mat');
bNewName = ['new' bfile.name];
save(bNewName, 'bu');
...
Extrct           =       "ExportSeqVideoFilesMixedMode(bu, FrameInfo, sout, 'Event', 'DLC', 'TimeRange', [1000 2500], 'SessionName',strrep(FrameInfo.MEDfile(1:10), '-', ''), 'RatName', FrameInfo.MEDfile(27:strfind(FrameInfo.MEDfile, '.')-1), 'Remake', 1, 'ExportRatio', 1);";
Extrct2           =       "ExportSeqVideoFilesMixedMode(bu, FrameInfo, sout, 'Event', 'Approach', 'TimeRange', [1000 2500], 'SessionName',strrep(FrameInfo.MEDfile(1:10), '-', ''), 'RatName', FrameInfo.MEDfile(27:strfind(FrameInfo.MEDfile, '.')-1), 'Remake', 1, 'ExportRatio',1);";
