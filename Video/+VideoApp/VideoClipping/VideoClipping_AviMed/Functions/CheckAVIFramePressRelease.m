...
set(hf19, 'name', 'Check press', 'units', 'centimeters', 'position', [5 5 40 20], 'paperpositionmode', 'auto',...
    'renderer','opengl','toolbar','none','resize','off');
...
%%
hf20 = figure(20); clf(hf20);
set(hf20, 'name', 'Check release', 'units', 'centimeters', 'position', [5 5 40 20], 'paperpositionmode', 'auto',...
    'renderer','opengl','toolbar','none','resize','off');
