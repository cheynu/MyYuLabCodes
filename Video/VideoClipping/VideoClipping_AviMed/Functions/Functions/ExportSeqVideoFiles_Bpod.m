...
switch lower(event)
    case {'trialstart'}
        ...
        fbar = waitbar(0,'Time remaining: calculating...','Name',strcat(bt.Subject(1)," ",num2str(bt.Date(1))));
        clc
        costTime = [];
%         occRAM = [];
...
%                         end
                    ...
                    set(hf25, 'name', 'side view', 'units', 'centimeters', 'position', [3 5 15 3+15*img_height/img_width],...
                    ...
                    seqTxt = max(40,ceil(img_height/27));
                    ...
                    text(10, seqTxt*2, [num2str(vid_fps),' FPS'], 'color', [246 233 35]/255, 'fontsize', 10,'fontweight', 'bold')
