...
function J = customcolormap_preset_z(preset_name)
...
%             J = customcolormap(linspace(0,1,11), {'#860454','#c51b7c','#dc75ab','#f0b7da','#ffdeef','#f8f7f7','#e5f4d9','#b9e084','#7fbc42','#4d921e','#276418'});
        case 'pink-white-green'
            J = customcolormap(linspace(0,1,11), {'#860454','#c51b7c','#dc75ab','#f0b7da','#ffdeef','#ffffff','#e5f4d9','#b9e084','#7fbc42','#4d921e','#276418'});
        ...
        case 'blue-light'
            J = customcolormap(linspace(0,1,4), {'#062e61','#2265ad','#4295c1','#93c5dc'});
        case 'red-light'
            J = customcolormap(linspace(0,1,4), {'#68011d','#b5172f','#d75f4e','#f7a580'});
        otherwise
