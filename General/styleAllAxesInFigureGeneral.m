function styleAllAxesInFigureGeneral(fig)
    ...
    for i = 1:length(ax)
        % Apply styling
        ax(i).TickLength = [0.025 0.015]; % Short ticks: [x-axis y-axis]
        ...
        ax(i).XLabel.Interpreter = 'tex'; % Support italicized labels
        ax(i).YLabel.Interpreter = 'none'; % For multiline ylabel
    end
