classdef BehaviorClass_WXN
    ...
    methods
        function obj = BehaviorClass_WXN(bdata)
        ...
        function value = get.CDF_HoldT(obj)
            ...
            for i =1:length(CDFOut)-1
                IndSelected                                      =          find(obj.FP==obj.MixedFP(i) & obj.Stage ==1& ~strcmp(obj.Outcome, 'Dark')& ~strcmp(obj.Outcome, 'NAN'));
                HoldTime                                          =          obj.ReleaseTime(IndSelected)- obj.PressTime(IndSelected);
                if ~isempty(HoldTime)
        ...
        function value = get.Anticipation(obj)
            ...
            for i = 1 : length(obj.MixedFP)
                datain{i} = HoldTime(obj.Stage==1 & obj.FP==obj.MixedFP(i));
            end
