...
set(fig_session, 'Visible', 'on', 'Units', 'centimeters', 'Position', [5 5 17 13], 'Color', 'w', 'toolbar', 'none');
...
% performance track
draw_perf_track(obj, fig_session, [1.2 4 5 4.5], ax_sz_4, obj.PerformanceTrack, ls, lw);
...
c_first = .4 * ones(1, 3);
c_last  = 0  * ones(1, 3);
ax_st_d = draw_density(obj, fig_session, [13 10 3.5 2], ax_sz_3, ...
    obj.LogSTPDF([1 end])', [], [], ...
    {{c_first}, {c_last}}, {'-', '-'}, {1, 1});
...
% hold duration
% scatter plot
ax_hd_s = draw_scatter(obj, fig_session, [7.5 7 ax_sz_1], ax_sz_5, ...
...
% prob. density
ax_hd_d = draw_density(obj, fig_session, [13 7 3.5 2], ax_sz_3, ...
...
% scatter plot
ax_mt_s = draw_scatter(obj, fig_session, [7.5 4 ax_sz_1], ax_sz_5, ...
...
% prob. density
ax_mt_d = draw_density(obj, fig_session, [13 4 3.5 2], ax_sz_3, ...
    obj.MTPDF, [], [], ...
    {{GPSColor.PortL}, {GPSColor.PortR}}, {ls, ls}, {lw, lw});
...
obj.plot_violin_compare(ax_rt_v, obj.RTSorted(:,1), obj.RTSorted(:,2), obj.BandWidth, ...
    "Color", {GPSColor.PortL, GPSColor.PortR}, "TextMedian", true, "cate_name", obj.TargetFP, 'Scale', 1000);
