...
Ind.short       = Behav.Stage==1 & Behav.FP==0.5;
Ind.med         = Behav.Stage==1 & Behav.FP==1;
Ind.long        = Behav.Stage==1 & Behav.FP==1.5;
...
Ind.late        = (strcmp(Behav.Outcome, 'LateCorrect') | strcmp(Behav.Outcome, 'LateWrong') | strcmp(Behav.Outcome, 'Late'));
