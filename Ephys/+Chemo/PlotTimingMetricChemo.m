function PlotTimingMetricChemo(TimingOut)
...
ha1info = axes('units', 'centimeters', ...
    ...
    'xlim',[0 8], 'ylim', ...
    [0 10], 'yticklabel', []);
text(1, 12,'a1*exp(-((x-b1)/c1)^2)', 'fontname', 'dejavu sans', 'fontsize', 8)
...
set(hbplot,{'linew'},{1})
h=findobj('LineStyle','--'); set(h, 'LineStyle','-', 'LineWidth', 1, 'color', 'b');
set(ha11, 'xtick', [1 2], 'xticklabel', {'Saline', 'DCZ'}, 'box','off' , 'position', [xnow, ynow plot_width plot_height])
xnow = xnow+plot_width;
...
set(hbplot,{'linew'},{1})
h=findobj('LineStyle','--'); set(h, 'LineStyle','-', 'LineWidth', 1, 'color', 'b');
set(ha22,'xtick', [1 2],  'xticklabel', {'Saline', 'DCZ'}, 'box','off' , ...
    'position', [xnow, ynow plot_width plot_height], 'ylim', yrange)
xnow = xnow+plot_width;
...
set(hbplot,{'linew'},{1})
h=findobj('LineStyle','--'); set(h, 'LineStyle','-', 'LineWidth', 1, 'color', 'b');
set(ha33,'xtick', [1 2], 'xticklabel', {'Saline', 'DCZ'}, 'box','off' , ...
    'position', [xnow, ynow plot_width plot_height],'ylim', yrange)
xnow = xnow+plot_width;
...
hui = uicontrol('style', 'text', 'units', 'normalized', 'position', [0.4 0.925 0.25 0.05],...
