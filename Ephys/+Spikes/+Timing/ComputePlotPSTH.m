...
for i =1:nTypes
    ...
    if  size(trialspxmat_late_presses{i}, 2)>3
        plot(ts_late_presses{i}, psth_late_presses{i}, 'color', late_col, 'linewidth', line_width ,'linestyle', line_style)
    end
end
...
for i =1:nTypes
    ...
    if  size(trialspxmat_late_releases{i}, 2)>3
        plot(ts_late_releases{i}, psth_late_releases{i}, 'color', late_col, 'linewidth', line_width ,'linestyle', line_style)
    end
end
axis 'auto y'
...
for i =1:nTypes
    ...
    plot(ts_reward_pokes{i}, psth_reward_pokes{i}, 'k', 'linewidth', line_width, 'linestyle', line_style);
