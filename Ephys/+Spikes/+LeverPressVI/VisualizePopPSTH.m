...
annotation('textbox', ...
    'Units', 'centimeters', ...
    'Position', [xlevel_start-1 ylevel_now 6 0.7], ...
    'String', 'A. Normalized activity ([0-1])', ...
...
if isfield(Pop,'UnitsColumn5')
    ...
    %     'string', [Pop.Name ' | ', Pop.UnitsColumn5{ib} ' | ' strrep(Pop.Session, '_', '-') ' | ' Pop.Protocol], ...
    %     'FontName','Dejavu Sans', 'fontweight', 'bold','fontsize', 12,'BackgroundColor','w')
    annotation('textbox', ...
        'Units', 'centimeters', ...
        'Position', [10 ylevel_now  6 2], ...
        'String', [Pop.Name ' | ', Pop.UnitsColumn5{ib} ' | ' strrep(Pop.Session, '_', '-') ' | ' Pop.Protocol], ...
        'FontName', 'Dejavu Sans', ...
        'FontWeight', 'bold', ...
        'FontSize', 12, ...
    ...
    % uicontrol('Style','text','Units','centimeters','Position',[10 ylevel_now  6 2],...
    %     'string', [Pop.Name ' | ' strrep(Pop.Session, '_', '-') ' | ' Pop.Protocol], ...
    %     'FontName','Dejavu Sans', 'fontweight', 'bold','fontsize', 12,'BackgroundColor','w')
    annotation('textbox', ...
        'Units', 'centimeters', ...
        'Position', [10 ylevel_now  6 2], ...
