function DataOut = PlotTrajectorySpikes_v3(sdf_unit, TrajTableAll, tReleasePoke, TimeStamp, video_path, unit_name, type, plot_rate, num_trajs)
if nargin<9
    num_trajs = [];
    if nargin<8
...
tReleases = tReleasePoke{1};
tPokes = tReleasePoke{2};
