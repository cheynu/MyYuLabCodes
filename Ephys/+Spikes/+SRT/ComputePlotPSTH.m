...
hf = figure(27); clf(hf);
set(hf, 'unit', 'centimeters', 'position', printsize, 'paperpositionmode', 'auto' ,'color', 'w')
...
annotation('textbox', ...
    'Units', 'centimeters', ...
    'Position', [1 yshift_row7+1.2 4 0.5], ...
...
annotation('textbox', ...
    'Units', 'centimeters', ...
    'Position', [7.75 yshift_row6 width+1 1], ...
    'String', 'B. Release-related', ...
    'FontName', 'Dejavu Sans', ...
    'FontWeight', 'bold', ...
    'FontSize', 10, ...
