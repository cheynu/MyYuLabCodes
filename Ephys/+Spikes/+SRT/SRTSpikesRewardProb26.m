function PSTH = SRTSpikesRewardProb26(r, ind, varargin)
...
warning('SRTSpikesRewardProb26:Deprecated', ...
    'SRTSpikesRewardProb26 is deprecated. Use Spikes.SRT.SRTSpikes26 instead.');


[varargout{1:nargout}] = Spikes.SRT.SRTSpikes26(r, ind, varargin{:});
...
for iku =1:length(ku_all)
    ...
    if ku == 1
        PSTH      = Spikes.SRT.ComputePlotPSTHRewardProb26(r, ku,...
        ...
        PSTH(ku)      = Spikes.SRT.ComputePlotPSTHRewardProb26(r, ku,...
            'PressTimeDomain', PressTimeDomain, ...
            'ReleaseTimeDomain', ReleaseTimeDomain, ...
            'RewardTimeDomain', RewardTimeDomain,...
            'TriggerTimeDomain', TriggerTimeDomain,...
