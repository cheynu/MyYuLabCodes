function PSTH = SRTSpikesWait26(r, ind, varargin)
...
% 1.10.2026 adapted for waiting learning
...
for iku =1:length(ku_all)
    ...
    if ku == 1
        PSTH      = Spikes.SRT.ComputePlotPSTHWait26(r, ku,...
        ...
        PSTH(ku)      = Spikes.SRT.ComputePlotPSTHWait26(r, ku,...
            'PressTimeDomain', PressTimeDomain, ...
            'ReleaseTimeDomain', ReleaseTimeDomain, ...
            'RewardTimeDomain', RewardTimeDomain,...
            'TriggerTimeDomain', TriggerTimeDomain,...
