classdef KilosortOutputClass<handle
    ...
    % written by HY
    % revised by JYu
    % revised by JYu to include a procedure to regenerate spike waveforms
    % (this is because we produce new clusters in SpikeChecker. Average
    % spike waveforms are not computed after the split.)
...
%             app.UIAxesRaster.Position=[530 340 580 352];
        ...
        function save(obj, dir_name)
            ...
            KilosortOutput = obj;
            save(fullfile(dir_name,'KilosortOutput.mat'), 'KilosortOutput', '-v7.3');
        end
